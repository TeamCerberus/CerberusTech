...
public class ClientPacketHandler implements IPacketHandler {
	...
	public static void sendComputerKeyboardEvent(int x, int y, int z, int dim, OSKeyboardEvents event, OSKeyboardLetters letter) {
	...
	public static void sendComputerPowerEvent(int x, int y, int z, int dim, int event) {
		ByteArrayOutputStream bos = new ByteArrayOutputStream(540);
		DataOutputStream dos = new DataOutputStream(bos);
		try {
			// writes basic packet data
