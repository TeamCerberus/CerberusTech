...
import teamcerberus.cerberustech.computer.TileEntityComputerMonitor;
import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class BlockComputerMonitor extends BlockContainer {
	public Icon[] icons;

	public BlockComputerMonitor(int id) {
		super(id, Material.rock);
		setUnlocalizedName("computermonitor");
	...
	public TileEntity createNewTileEntity(World world) {
		return new TileEntityComputerMonitor();
	}
