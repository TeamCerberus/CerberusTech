...
import beanshell.BshClassManager;
import beanshell.ClassPathException;
import beanshell.Interpreter;
import beanshell.UtilEvalError;
import beanshell.classpath.BshClassPath.ClassSource;
import beanshell.classpath.BshClassPath.GeneratedClassSource;
import beanshell.classpath.BshClassPath.JarClassSource;
...
{
	static final String BSH_PACKAGE = "beanshell";
	/**
	...
	*/
	...
	public Class defineClass( String name, byte [] code )
	{
		...
		try {
			...
			throw new beanshell.InterpreterError("defineClass: "+e);
		}
