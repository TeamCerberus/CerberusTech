...
public final class This implements java.io.Serializable, Runnable 
{
	...
	*/
	...
	/**
		getThis() is a factory for beanshell.This type references.  The capabilities
	...
	*/
	...
	/**
		...
		Don't give beanshell.This a chance to override their behavior.
		<p>

		If the method is passed here the invocation will actually happen on
		the beanshell.This object via the regular reflective method invocation 
		mechanism.  If not, then the method is evaluated by beanshell.This itself
