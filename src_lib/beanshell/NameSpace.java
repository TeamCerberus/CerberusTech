...
/**
	...
	A beanshell.This object is a thin layer over a NameSpace that associates it with
...
public class NameSpace implements Serializable, BshClassManager.Listener, NameSource, Cloneable {
	...
	*/
	...
	/**
		...
		Note: this method should probably return type beanshell.This to be consistent
		with getThis();
	*/
...
// this?
	...
	*/
	...
	/**
		...
		@see beanshell.This.invokeMethod( 
	...
	*/
    public void loadDefaultImports()
    {
		...
		*/
		...
		importPackage("java.io");
		importPackage("java.lang");
		importCommands("/beanshell/commands");
    }
